...
export default function CocktailsScreen() {
  ...
  useEffect(() => {
    fetch(`${API_BASE}/bond/cocktails`)
      .then(r => r.json())
      .then(d => setCocktails(d.cocktails))
      .catch(() => {});
  }, []);
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>
            Bond's diet during Casino Royale filming was disciplined — alcohol was the exception, not the rule. These are tools of character, not habits.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
